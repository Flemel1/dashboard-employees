...
const Salarypage = () => {
  ...
  const { data, isLoading } = useFetch(
    "http://localhost:8001/api/salaries-five-year"
  )
  const { data: data2, isLoading: isLoading2 } = useFetch(
    `http://localhost:8001/api/salaries/${year}`
  )
  ...
  return (
    <div>
      ...
      {isLoading === true || isLoading2 === true ? (
        ...
        <div className="salary__charts">
          <div className="salary__charts__all">
            <LineChart
              data={{
                labels: labels,
                datasets: [
          ...
          <div className="salary__charts__year">
